...
class LLaVATrainer(Trainer):
    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            #         print("requires_grad: {}".format(key))
            ...
            if self.args.mm_projector_lr is not None and self.args.mm_projector_lr != 0:
                print(
                   f"lr: {self.args.learning_rate}, projector lr: {self.args.mm_projector_lr}, vision lr {self.args.vision_tower_lr}")
                ...
                if self.args.vision_tower_lr is not None and self.args.vision_tower_lr != 0:
                    ...
                    print(f"lr: {self.args.learning_rate}, projector lr: {self.args.mm_projector_lr}, vision lr {self.args.vision_tower_lr}")
                    optimizer_grouped_parameters = [
                        {
                            "params": [
