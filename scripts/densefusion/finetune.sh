...
MODEL="densefusion-7b-finetune-llava-v1.5"

DATA_PATH="your_data_path/llava_v1_5_mix665k.json"
IMAGE_FOLDER="your_data_path/"


export CKPT_PATH=checkpoints/densefusion-7b-pretrain-llava-v1.5
export VIT_PATH=checkpoints/densefusion-7b-pretrain-llava-v1.5/vision_tower
